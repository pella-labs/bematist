# `legal/templates/` — Compliance artifact index

**Owner:** Sandesh (Workstream I — Compliance)
**Status:** scaffold (Sprint 1 Day 1)
**Scope:** Sprint 1 → M3 PoC ship

This directory holds the customer-facing compliance artifacts DevMetrics needs to sell into
