...
import { Slide06ThankYou } from "./slides/06-thank-you";
import { useDeckNav } from "./use-deck-nav";

// Five-slide pitch cut: cover -> problem+solution (black box) -> demo ->
// closing -> team thank-you (Q&A holder). All other slide files remain in
// the slides/ dir for reference but are no longer rendered.
const SLIDE_LABELS = [
  "Cover",
  "Problem",
  "Demo",
...
export default function DeckPage() {
  ...
  const renderSlide = (i: number, _active: boolean) => {
    switch (i) {
      ...
      case 4:
        return <Slide06ThankYou totalPages={TOTAL} />;
      default:
        return null;
    }
  };
