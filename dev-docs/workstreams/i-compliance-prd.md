...
### §11.1 Research gaps (need follow-up presearch)

- **OQ-1. French CSE template text not located.** Presearch 2026-04-16 found no published template for Art. L1222-4 + L2312-38. **Action:** queue a follow-up presearch pass targeting CGT + CFDT publications; if blank, author from statute + CNIL guidance and flag in `cse-consultation-FR.md` preamble as "synthesized, pending counsel review."
- **OQ-2. Italian Art. 4 Statuto dei Lavoratori template text not located.** Same as OQ-1, target CGIL + UIL publications.
- **OQ-3. Hanse Betriebsratsseminare sample BV PDF body text not extractable via WebFetch.** **Action:** local PDF download + OCR pass before finalizing `works-agreement-DE.md` to capture verbatim best-practice clauses.
...
| E-3 | Queue follow-up presearch for FR (CGT templates) + IT (CGIL templates) | S2 | CR-1 / OQ-1 / OQ-2 — can't ship in FR/IT mid-market without these |

## 13. Risks

| # | Risk | Severity | Mitigation |
|---|---|---|---|
| CR-1 | FR + IT template sourcing gap (OQ-1, OQ-2) → can't ship in FR/IT mid-market | HIGH | Follow-up presearch queued (E-3); fallback: author from statute + CNIL/Italian-Garante guidance + flag "synthesized, pending counsel review" in preamble |
