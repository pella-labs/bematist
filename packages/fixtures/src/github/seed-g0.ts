      ...
      commits: [
        {
          ...
          author: { name: "Fixture Engineer", email: `${SENDER_LOGIN}@example.com`, username: SENDER_LOGIN },
          committer: { name: "Fixture Engineer", email: `${SENDER_LOGIN}@example.com`, username: SENDER_LOGIN },
        ...
        pull_requests: [
          {
            id: 111001,
            number: 7,
            head: { ref: "feature/fixture-branch", sha: HEAD_SHA, repo: { id: REPO_ID, name: REPO_NAME } },
