...
- 2026-04-16 — Naming retrofit: product and CLI are `Bema` / `bematist` everywhere (single name across all surfaces; supersedes PRD §D32 "DevMetrics stays the product name").
